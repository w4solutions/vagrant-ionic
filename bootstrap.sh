...
echo "PATH=\$PATH:/opt/gradle/gradle-4.1/bin" >> /home/ubuntu/.bashrc
...
expect -c '
set timeout -1   ;
spawn /home/ubuntu/android-sdk-linux/tools/bin/sdkmanager "platform-tools" "platforms;android-25" "build-tools;26.0.1" --sdk_root=/home/ubuntu/android-sdk-linux/ 
expect {
